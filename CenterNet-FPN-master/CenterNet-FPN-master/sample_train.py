...
if __name__ == '__main__':
    ...
    trainloader = DataLoader(trainset, batch_size=1, shuffle=True, num_workers=0, pin_memory=True)
    testset = VOC_data(tests, img_dir, test_flag=True)
    testloader = DataLoader(testset, batch_size=1, shuffle=True, num_workers=0, pin_memory=True)
